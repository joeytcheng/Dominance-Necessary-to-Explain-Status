Dominance-Necessary-to-Explain-Status
=====================================
...
1. Download (to a single folder) all datasets collected in: (a) Durkee et al.'s original article (https://osf.io/3x8um/) [5 data files]; and (b) our current reply (https://github.com/joeytcheng/Dominance-Necessary-to-Explain-Status/tree/main/replyData) [3 data files]
